...
use LimenAi\Http\Controllers\Api\AgentController;
...
use LimenAi\Http\Controllers\Api\GuestSessionController;
...
Route::prefix($prefix)
    ...
    ->name('limen-ai.')
    ->group(function (): void {
        Route::get('agents/{agentKey}', [AgentController::class, 'show'])->name('agents.show');
        ...
        Route::post('guest/session', [GuestSessionController::class, 'store'])->name('guest.session');
