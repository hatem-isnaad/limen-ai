...
class RepositoryBindingsTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(CompositeAgentRepository::class, app(AgentRepository::class));
        $this->assertInstanceOf(ConfigToolRepository::class, app(ToolRepository::class));
